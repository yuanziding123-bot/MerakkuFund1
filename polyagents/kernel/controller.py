...
_SYS = (
    ...
    "'Can I hedge/lock a profit on <market>', '区间对冲 / 对冲锁利 / 波动够不够锁利 / 这个市场能不能对冲套利 / "
    "hedge lock' → hedge_scan (measures a market's price swing + the max lockable hedge profit; "
    "needs the range-hedge pack).\n"
